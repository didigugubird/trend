...
import com.digubird.client.IndexDataClient;
...
public class BackTestService {
    final IndexDataClient indexDataClient;
    public BackTestService(@Qualifier("com.digubird.client.IndexDataClient") IndexDataClient indexDataClient){
